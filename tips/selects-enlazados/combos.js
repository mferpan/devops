...
function cargaContenido(idSelectOrigen) {
	...
	if(opcionSeleccionada==0) {
		...
		while(listadoSelects[x]) {
			...
			var nuevaOpcion=document.createElement("option"); nuevaOpcion.value=0; nuevaOpcion.innerHTML="Select an option...";
	...
	// Compruebo que el select modificado no sea el ultimo de la cadena
		...
		var ajax=nuevoAjax();
		ajax.open("GET", "procesador.php?select="+idSelectDestino+"&opcion="+opcionSeleccionada, true);
